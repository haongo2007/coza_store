	...
	<div class="container">
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				...
				?>
					<button url="<?php echo base_url('home/test') ?>" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"  data-filter=".<?php echo $key->id  ?>">
						<?php echo $key->name; ?>
					</button>
				<?php 
					}
			...
			<div class="dis-none panel-filter w-full p-t-10">
				<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
					<div class="filter-col1 p-r-15 p-b-27">
						...
						<ul>
							<li class="p-b-6">
								<a href="javascript:void(0)" data-sort='{ "sortBy" : "random" }' class="filter-link stext-106 trans-04">
									Default
								</a>
							</li>
							...
							<li class="p-b-6">
								<a href="javascript:void(0)" data-sort='{ "sortBy": "product_price", "sortAscending": true }' class="filter-link stext-106 trans-04">
									Price: Low to High
								</a>
							</li>

							<li class="p-b-6">
								<a href="javascript:void(0)" data-sort='{ "sortBy": "product_price", "sortAscending": false }' class="filter-link stext-106 trans-04">
									Price: High to Low
								</a>
							</li>
						</ul>
					...
					<div class="filter-col3 p-r-15 p-b-27">
						...
						<ul>
							<?php foreach ($arr_fil_clr as $name => $code) { ?>
							<li class="p-b-6">
								<span class="fs-15 lh-12 m-r-6" style="color: <?php echo $code; ?>;">
		...
		<div class="row isotope-grid">
			...
			?>
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $key->catalog_id.' '.$key->type_id.' '.$key->tag_find; ?>">
				<!-- Block2 -->
				<div class="block2" id="<?php echo $key->id ?>">
